...
pandoc -s --metadata pagetitle="Higher Structures in Enumerative Geometry" -c GitHub2.css june2023.md -o june2023.html
pandoc -s --metadata pagetitle="Dg-manifolds in Geometry and Physics" -c GitHub2.css july2023.md -o july2023.html
