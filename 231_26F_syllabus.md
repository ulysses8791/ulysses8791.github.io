---
layout: default
title: Syllabus for MATH 231 in Fall 2026
---
...
- Office hours are designed for clarification and conceptual guidance. They are _not_ a time for instructors to re-lecture missed content. If you miss class, obtain notes from a classmate.
...
We will use [Canvas](https://canvas.psu.edu) and [Gradescope](https://www.gradescope.com) to administer assignments, record scores and share course materials.
...
4. In [Gradescope](https://www.gradescope.com), once you have uploaded your PDF file, **you must match the pages of your document to the questions of the assignment**. Otherwise, your submission will be considered incomplete and will receive a zero score.
...
Your grade will be based _exclusively_ on the weekly homework, in-class quizzes, the two evening examinations, and the comprehensive final exam. There is _no 'extra credit' work_.
...
Students must file for conflict exams through [LionPATH](https://lionpath.psu.edu) between **Monday, September 28, 2026, and Sunday, October 25, 2026**. Conflict final exams _cannot_ be scheduled through the Mathematics Department.
...
If you suspect a grading error on your exam or quiz, please submit a regrade request via [Gradescope](https://www.gradescope.com) for that specific question. Be sure to provide a clear explanation of why you believe your work warrants a review.
...
**University Health Services (UHS) Guidelines:** For routine illness, email faculty before missing quizzes or examinations. UHS provides illness verification forms only for major illnesses lasting at least a week. Request forms during clinical visits or through myUHS at [studentaffairs.psu.edu/health/myuhs](https://studentaffairs.psu.edu/health/myuhs). Outside medical documentation must be submitted to the UHS Director (502A Student Health Center, 814-865-6555).

Relevant Senate Policies: [Senate Policy 42-27](https://senate.psu.edu/policies-and-rules-for-undergraduate-students/42-00-acquisition-of-credit/#42-27), [Policy E-11](https://aappm.psu.edu/policy/e-11-class-attendance), and the [University Excused Absence Form](https://aappm.psu.edu/files/class_absence_v3.pdf).
...
Mathematics Learning Assistants (LAs) host weekly evening problem sessions in campus classrooms.
* **Incentive Structure:** Earn up to **three perfect score replacements** for your lowest quiz or worksheet scores by attending LAPS sessions:
  1. **Replacement 1:** Attend 6 evening sessions during **Weeks 2–8**.
  2. **Replacement 2:** Attend 6 evening sessions during **Weeks 9–15**.
  3. **Replacement 3:** Attend a combined **12 LA sessions** across the entire semester.
* **LAPS Rules:**
  * Maximum of 2 qualifying sessions per week count toward the incentive.
  * You must remain for an extended duration and actively work on the designated LAPS worksheets (not homework or classwork).
  * Complete the required attendance form for every session. Retain survey confirmation emails as official proof of attendance in case of recording discrepancies.
